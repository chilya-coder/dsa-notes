...
<h2><a href="https://leetcode.com/problems/maximum-score-after-splitting-a-string">1422. Maximum Score After Splitting a String</a></h2><h3>Easy</h3><hr><p>Given a&nbsp;string <code>s</code>&nbsp;of zeros and ones, <em>return the maximum score after splitting the string into two <strong>non-empty</strong> substrings</em> (i.e. <strong>left</strong> substring and <strong>right</strong> substring).</p>
